...
# Main program to compile (change this variable to choose a different main)
MAIN = main.cpp

# Object file corresponding to the selected main
MAIN_OBJ = $(BUILDIR)/$(MAIN:.cpp=.o)

all: $(TARGET)

# Link object file of the selected main to executable into the bin directory
$(TARGET): $(MAIN_OBJ) $(filter-out $(MAIN_OBJ), $(OBJ_FILES))
	@mkdir -p $(BINDIR)
