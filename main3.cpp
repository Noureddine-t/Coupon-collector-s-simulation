...
int main() {
    ...
    for (int i = 1; i <= N; i++) {
        ...
        for (int j = 0; j < simulations; j++) {
            averageWeeks[0] += simulateWithMultipleCollections(i, 2/*1 ou 2*/); //vignetteNumber=1 ou 2
            averageWeeks[1] += simulateWithMultipleCollectionsWithExchange(i, 2/* 1 ou 2*/);//vignetteNumber=1 ou 2
        }
